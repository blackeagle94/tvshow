...
function Episodes(props) {
	...
	return (
		<div>
			...
			<Link to="/tvshow"><button className="btn btn-light">Home Page</button></Link>
				<Link to="/tvshow/seasons"><button className="btn btn-light">Go Back to Seasons</button></Link>
			</div>
